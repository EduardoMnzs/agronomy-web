              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-gray-50 dark:bg-[#2c3033] border border-gray-200 dark:border-transparent focus:bg-white dark:focus:bg-[#323639] focus:border-[#EC6608] rounded-lg text-sm text-[#131E29] dark:text-white outline-none resize-none"
                  />
                </div>
              </div>
