            ...
            >
              {loading ? (
                ...
                filteredDocs.map((doc) => (
                  <DocumentCard key={doc.id} doc={doc} canDelete={isAdmin} onDelete={() => handleDeleteClick(doc)} onPreview={() => handlePreviewClick(doc)} onDownload={() => handleDownloadClick(doc)} variants={itemVariants} />
                ))
              ) : (
...
function DocumentCard({ doc, onDelete, onPreview, onDownload, canDelete, variants }) {
